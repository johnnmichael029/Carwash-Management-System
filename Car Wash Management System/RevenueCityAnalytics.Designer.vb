...
Partial Class RevenueCityAnalytics
    ...
    Private Sub InitializeComponent()
        Panel10 = New Panel()
        PanelChartRevenueCity = New Panel()
        Panel2 = New Panel()
        ...
        ' Panel10
        ' 
        Panel10.BackColor = Color.FromArgb(CByte(241), CByte(244), CByte(254))
        Panel10.Controls.Add(PanelChartRevenueCity)
        ...
        Panel10.TabIndex = 11
        ' 
        ' PanelChartRevenueCity
        ' 
        PanelChartRevenueCity.BackColor = Color.White
        PanelChartRevenueCity.Location = New Point(0, 128)
        PanelChartRevenueCity.Name = "PanelChartRevenueCity"
        PanelChartRevenueCity.Size = New Size(1192, 552)
        PanelChartRevenueCity.TabIndex = 7
        ' 
        ' Panel2
        ' 
        ...
        Panel2.Location = New Point(2909, 128)
        Panel2.Name = "Panel2"
        ...
        LabelOrders.Location = New Point(58, 183)
        ...
        PanelChartCustomers.Location = New Point(2673, 407)
        PanelChartCustomers.Name = "PanelChartCustomers"
        PanelChartCustomers.Size = New Size(219, 2544)
        ...
        Panel3.Location = New Point(2909, 314)
        Panel3.Name = "Panel3"
        ...
        LabelCustomers.Location = New Point(58, 183)
        ...
        Panel4.Location = New Point(2907, 501)
        Panel4.Name = "Panel4"
        ...
        LabelEarnings.Location = New Point(58, 183)
        ...
        Name = "RevenueCityAnalytics"
        Text = "RevenueCityAnalytics"
    ...
    Friend WithEvents PanelChartRevenueCity As Panel
